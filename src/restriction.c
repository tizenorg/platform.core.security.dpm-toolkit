...
int set_clipboard_state_handler(struct dpm_toolkit_entity* self)
{
	...
	if (set_value == true && enable != true) {
		...
		if(set_value == true) display_result_popup((char *)xmlGetProp(self->model, (xmlChar *) "desc"), "ON");
		else display_result_popup((char *)xmlGetProp(self->model, (xmlChar *) "desc"), "OFF");
	}
...
int get_clipboard_state_handler(struct dpm_toolkit_entity* self)
{
	...
	if(enable == true) display_result_popup((char *)xmlGetProp(self->model, (xmlChar *) "desc"), "ON");
	else if(enable == false) display_result_popup((char *)xmlGetProp(self->model, (xmlChar *) "desc"), "OFF");
